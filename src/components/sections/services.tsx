          ...
          <Carousel opts={{ loop: true }} className="w-full">
            <CarouselContent>
              {services.map((service) => {
                ...
                return (
                  <CarouselItem key={service.slug} className="basis-full">
                    <Card className="flex h-full flex-col border border-gray-200 transition hover:border-blue-500 hover:shadow-lg">
                      <CardHeader>
